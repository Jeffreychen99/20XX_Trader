...
handler = RotatingFileHandler("etrade/etrader.log", maxBytes=5*1024*1024, backupCount=3)
...
def oauth():
    ...
    text_code = input("%s \nPlease accept agreement and enter text code from browser: " % authorize_url)
